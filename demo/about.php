                    ...
                    <div class="container">
                        ...
                        <!-- <div class="counter-inner">
                            <div class="counter-item-wrap row">
                                <div class="col-lg-3 col-sm-6 counter-item">
                                    <div class="counter-no"><span class="counter">45</span>k+</div>
                                    <div class="Completed">
                                        Active Students
                                    </div>
                                </div>
                                <div class="col-lg-3 col-sm-6 counter-item">
                                    <div class="counter-no"><span class="counter">72</span>+</div>
                                    <div class="Completed">
                                        Faculty Courses
                                    </div>
                                </div>
                                <div class="col-lg-3 col-sm-6 counter-item">
                                    <div class="counter-no"><span class="counter">90</span>+</div>
                                    <div class="Completed">
                                        Best Professors
                                    </div>
                                </div>
                        ...
                        <div class="row pt-5">
                            <div class="col-md-6">
                                <h4>Father :</h4>
                                <p class="about-describe info-left">
                                    Sangeetha Vidwan, Sahidya Kartha Sulur Sri. <b>T. Swarnakuzhandaivel</b>
                                </p>
                            </div>
                            <div class="col-md-6">
                                <h4>Grand Father :</h4>
